...
import { MR_CATS, MR_ARTS } from "@/lib/data";
      ...
      <section className="sec mr" style={{ paddingTop: 0 }}>
        <div className="wrap">
          ...
          <div className="mr-grid">
            {MR_ARTS.map((a) => (
              <Link href="/articulo/ansiedad" className="mr-card" key={a.t}>
                <Placeholder v={a.v} tag="Fotografía editorial" className="ph-mr" />
                <div className="mr-card-b">
                  <span className="card-cat" style={{ color: "var(--mr-deep)", opacity: 0.7 }}>
                    {a.c}
                  </span>
                  <h3 style={{ marginTop: 7 }}>{a.t}</h3>
